...
p <- ggplot(
  ...
  labs(
    title = "Figure S4. Condition-specific SSI distributions",
...
ggsave(
  file.path(OUTDIR, "FigureS4_condition_specific_SSI_distributions.pdf"),
  p,
  width = 8.8,
  height = 5.4,
  device = "pdf"
...
if (requireNamespace("ragg", quietly = TRUE)) {
  ggsave(
    file.path(OUTDIR, "FigureS4_condition_specific_SSI_distributions.png"),
    p,
    width = 8.8,
    height = 5.4,
    dpi = 300,
...
write_tsv(
  df_clean,
  file.path(OUTDIR, "FigureS4_source_data.tsv")
)

cat("Generated final Figure S4:\n")
cat(file.path(OUTDIR, "FigureS4_condition_specific_SSI_distributions.pdf"), "\n")
cat(file.path(OUTDIR, "FigureS4_condition_specific_SSI_distributions.png"), "\n")
